...
export async function cancelDeliveryOrder(id, phone = '') {
  return rpc('cancel_delivery_order', { p_id: id, p_phone: phone });
}

export async function updateDeliveryOrder(payload) {
  return rpc('update_delivery_order', { p: payload });
}
