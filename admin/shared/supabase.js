// Aquarium Cafe & Restaurant — Admin Supabase client
...
// Admin intentionally authenticates with a staff Supabase session. A separate
// storage key prevents a customer session from being reused by this app.
export const supabase = createClient(
  ...
  { auth: { persistSession: true, autoRefreshToken: true, detectSessionInUrl: true, storageKey: 'aquarium-auth-admin' }, realtime: { params: { eventsPerSecond: 10 } } }
);
